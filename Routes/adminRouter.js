...
const {isAdminLoginExist,addProductController,getAllproductController,deleteProductController,getAllUserController,deleteUserController,blockAndUnblockUserController,editProductController} =require("../Controller/adminController.js")
const multerConfig = require("../middleware/multerMiddleWare.js")
//admin login verification
router.post("/login",isAdminLoginExist)
//admin add product
router.post("/addproduct",jwtVerification,multerConfig.array("uploadimages",4),addProductController)
...
router.patch("/blockandunblockuser",jwtVerification,blockAndUnblockUserController)

//admin want to update the product

router.put("/adminProductUpdationSubmit",jwtVerification,multerConfig.array("uploadimages",4),editProductController)
